<template>
	<view>
		<view class="head position-relative">
			...
			<view class="txt px-3 font-32 colorf">{{info.company?info.company:''}}<view class="tag tagName1 ml-2">已实名认证</view></view>
		</view>
		
		<view class="px-3 bg-white">
			<view class="font-26 color9 py-3 borderB-e1 position-relative">{{info.passage1?info.passage1:''}}<image src="../../static/images/labor%20releasel-icon1.png" class="icon1"></image></view>
		...
		<!-- 列表 -->
		<view class="list">
			<view class="item d-flex a-center j-sb p-3 bg-white mb-2"  v-for="(item,index) of relationData"
		...
		<view class="bg-mask" v-show="share_show">
			<view class="bg-white rounded20-T color2 font-28 text-center position-absolute bottom-0 left-0 right-0">
				...
				<view class="d-flex a-center j-sb share m-a mb-5 pt-3">
					...
					<view class="font-26 pb-1" 
					@click="Router.navigateTo({route:{path:'/pages/secondHand-detailCompany-share/secondHand-detailCompany-share?user_no='+user_no}})"><image src="../../static/images/sharel-icon1.png" class="img2"></image><view>微信朋友圈</view></view>
				</view>
...
.head image{height: 240rpx;}
.head .txt{line-height: 80rpx;position: absolute;bottom: 0;left: 0;right: 0;background-color: rgba(0,0,0,0.5);}

.icon1{width: 19rpx;height: 10rpx;position: absolute;bottom: -10rpx;right: 0;}

.icon2{width: 20rpx;height: 26rpx;margin-right: 10rpx;}
.userImg{width: 100rpx;height: 100rpx;}
.btn{width: 200rpx;line-height: 50rpx;}
