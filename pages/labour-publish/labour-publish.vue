<template>
	<view>
		...
		<view class="card1 bg-white">
			...
			<view class="px-3 mt-2" v-show="navCurr==1">
				...
				<view class="d-flex a-center pb-2">
					<view class="font-26 position-relative select">
						<input type="text" placeholder="请选择" value="电焊工" class="text-left border-e1 rounded color2 pl-1 borderBox"/>
					...
					<input type="text" placeholder="请填写" value="3" class="text-left border-e1 rounded color2 pl-1 borderBox select1"/>
					<input type="text" placeholder="不填为面议" class="text-left border-e1 rounded color2 pl-1 borderBox select1"/>
				</view>
				<view class="d-flex a-center pb-2">
					<view class="font-26 position-relative select">
						<input type="text" placeholder="请选择" class="text-left border-e1 rounded color2 pl-1 borderBox"/>
						<view class="icon2Box">
					...
					<input type="text" placeholder="请填写" class="text-left border-e1 rounded color2 pl-1 borderBox select1"/>
					<input type="text" placeholder="不填为面议" class="text-left border-e1 rounded color2 pl-1 borderBox select1"/>
			...
			<view class="d-flex a-center j-center py-4">
